...
class HardwareExecutor:
    ...
    def execute_segment(
        ...
        *,
        ...
        self._wait_for_start_state(samples[0], label, check_turn=command_turn)
        trajectory = self._make_trajectory(samples, command_turn=command_turn)
        ...
        *,
        ...
        while time.monotonic() < deadline:
            ...
            if (
                ...
                checked_joint_names = (
                    (*ARM_JOINT_NAMES, "turn") if check_turn else ARM_JOINT_NAMES
                )
                joint_errors = {
