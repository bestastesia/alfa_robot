...
class PlcDriver:
    ...
    def hold_move_abs(self, axes: Sequence[int]) -> list[AxisStatus]:
        return self.write_control_word(axes, ControlWord.ENABLE_MOVE_ABS)

    def soft_stop(self, axes: Sequence[int]) -> list[AxisStatus]:
        return self.write_control_word(axes, ControlWord.ENABLE_STOP)
