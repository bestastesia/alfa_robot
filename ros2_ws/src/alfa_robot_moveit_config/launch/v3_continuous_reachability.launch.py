...
def generate_launch_description():
    ...
    arguments = [
        ...
        DeclareLaunchArgument("x_start_min", default_value="0.35"),
        DeclareLaunchArgument("x_start_max", default_value="0.75"),
        ...
        DeclareLaunchArgument("lateral_min", default_value="-0.55"),
        DeclareLaunchArgument("lateral_max", default_value="0.85"),
        DeclareLaunchArgument("lateral_step", default_value="0.05"),
        DeclareLaunchArgument("height_min", default_value="0.05"),
        DeclareLaunchArgument("height_max", default_value="1.20"),
