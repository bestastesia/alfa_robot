...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("extract_local_repair_backend", default_value="curobo"),
        DeclareLaunchArgument("extract_local_curobo_enabled", default_value="false"),
        DeclareLaunchArgument("extract_local_curobo_coupled_13d", default_value="true"),
        DeclareLaunchArgument("extract_local_curobo_service", default_value="/robot_motion/plan_joint_segment"),
        DeclareLaunchArgument("extract_local_curobo_scene_id", default_value=""),
        DeclareLaunchArgument("extract_local_curobo_timeout_s", default_value="0.5"),
        DeclareLaunchArgument("extract_local_curobo_window_points", default_value="8"),
        DeclareLaunchArgument("extract_local_curobo_boundary_backoff_points", default_value="5"),
        DeclareLaunchArgument("extract_local_curobo_max_segments", default_value="4"),
        DeclareLaunchArgument("extract_local_curobo_max_calls_per_plan", default_value="8"),
        DeclareLaunchArgument("extract_local_curobo_max_attempts", default_value="3"),
        DeclareLaunchArgument("extract_local_curobo_force_graph", default_value="true"),
        DeclareLaunchArgument("extract_local_curobo_fallback_to_rrt", default_value="true"),
        ...
        DeclareLaunchArgument("extract_loaded_candidate_order_filter", default_value="-1"),
    ...
    dual_arm_planner = Node(
        ...
        parameters=[
            ...
            moveit_config.joint_limits,
            {
                ...
                "extract_local_repair_backend": ParameterValue(LaunchConfiguration("extract_local_repair_backend"), value_type=str),
                "extract_local_curobo_enabled": ParameterValue(LaunchConfiguration("extract_local_curobo_enabled"), value_type=bool),
                "extract_local_curobo_coupled_13d": ParameterValue(LaunchConfiguration("extract_local_curobo_coupled_13d"), value_type=bool),
                "extract_local_curobo_service": LaunchConfiguration("extract_local_curobo_service"),
                "extract_local_curobo_scene_id": LaunchConfiguration("extract_local_curobo_scene_id"),
                "extract_local_curobo_timeout_s": ParameterValue(LaunchConfiguration("extract_local_curobo_timeout_s"), value_type=float),
                "extract_local_curobo_window_points": ParameterValue(LaunchConfiguration("extract_local_curobo_window_points"), value_type=int),
                "extract_local_curobo_boundary_backoff_points": ParameterValue(LaunchConfiguration("extract_local_curobo_boundary_backoff_points"), value_type=int),
                "extract_local_curobo_max_segments": ParameterValue(LaunchConfiguration("extract_local_curobo_max_segments"), value_type=int),
                "extract_local_curobo_max_calls_per_plan": ParameterValue(LaunchConfiguration("extract_local_curobo_max_calls_per_plan"), value_type=int),
                "extract_local_curobo_max_attempts": ParameterValue(LaunchConfiguration("extract_local_curobo_max_attempts"), value_type=int),
                "extract_local_curobo_force_graph": ParameterValue(LaunchConfiguration("extract_local_curobo_force_graph"), value_type=bool),
                "extract_local_curobo_fallback_to_rrt": ParameterValue(LaunchConfiguration("extract_local_curobo_fallback_to_rrt"), value_type=bool),
                ...
                "extract_loaded_candidate_order_filter": ParameterValue(LaunchConfiguration("extract_loaded_candidate_order_filter"), value_type=int),
