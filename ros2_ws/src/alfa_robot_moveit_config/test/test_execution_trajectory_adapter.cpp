...
int main()
{
  ...
  assert(adapter.alfaToMoveItJointName("left_joint3") == "left_joint3");
  assert(adapter.moveItToAlfaJointName("right_joint6") == "right_joint6");
