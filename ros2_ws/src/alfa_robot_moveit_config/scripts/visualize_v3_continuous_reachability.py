        ...
        rrb.Blueprint(
            rrb.Horizontal(
                rrb.Spatial3DView(
                    ...
                    name="Sandwiched collision trajectories",
                ),
                    ...
                    rr.TextDocument(
                        "\n".join(
                            [
                                ...
                                "- Cyan: commanded Cartesian disk path.",
...
def main() -> int:
    ...
    if args.jump_component_seed and args.jump_case_center:
        raise RuntimeError("--jump-component-seed 和 --jump-case-center 不能同时使用")
    ...
    log_robot_static_model(robot, "robot", log_meshes=not args.no_meshes)
