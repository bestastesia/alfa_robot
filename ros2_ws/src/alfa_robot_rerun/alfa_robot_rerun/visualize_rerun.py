#!/usr/bin/env python3
"""
ALFA Robot 通用 URDF/FK 可视化与 IK Benchmark 回放。
...
用法:
  ros2 run alfa_robot_rerun visualize_rerun /tmp/ik_benchmark.jsonl
  ros2 run alfa_robot_rerun visualize_rerun result.jsonl --connect
"""
