...
- 默认初始姿态：用户最终指定左右臂均为 `J1～J7=[0,-90,-90,0,-90,0,0]°`，共享 `updown=0m`、`head_joint=0°`。已同步 description xacro 默认参数、模型查看器、两套 mock ros2_control、MoveIt initial positions、SRDF `home` 和连续可达性默认 seed。
