...
| --- | --- | --- | --- | --- | --- |
| T-0024 | DOING | 机械工程师 | 在三维坐标系中标定 T 电机连接点、旋转点和旋转方向 | `motor_model/T电机.stl`、必要的只读可视化/包围盒检查、`.ai_teamwork/MOTOR_MODEL_CALIBRATION.md` | 已完成候选 A 标定与确认材料，等待用户验收：joint origin `[0,0,0]`、axis `[0,0,1]`、parent `[0,0,-0.075]`、child `[0,0.075,0]`；确认图/URDF 在 `.ai_teamwork/motor_calibration/`；用户确认后再标 DONE 或按反馈改候选 B |
